...
describe('Header Component', () => {
  ...
  beforeEach(() => {
    const props = {
      ...
      logoutUrl: 'https://www.exampleGlobalHeader.com/HeaderComponent-12345_TESTING',
    }
  ...
  it('renders ', () => {
    ...
    expect(wrapper.find('GlobalHeader').props().profileName).toEqual('lastname firstname')
  })
