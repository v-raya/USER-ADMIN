...
describe('ShowField', () => {
  ...
  beforeEach(() => {
    component = shallow(<ShowField {...props}>This is the show field value</ShowField>)
  ...
  it('passes props to the FormField', () => {
    ...
    expect(formField.props().children).toEqual(<span>This is the show field value</span>)
  })
